...
public class App {
	...
	public static void main(String[] args) {
		...
		Pelicula pelicula = new Pelicula(pelisList[randomRange(0, pelisList.length - 1)],
				randomRange(90, 240), // Duracion de la peli
				randomRange(12, 18), // Edad Minma
				"D. Jose Marín");
		...
		for (int i = 0; i < numEspectadores  &&  i < asientosDisponibles ; i++) {
			...
			espectador = new Espectador(espectadoresList[randomRange(0, espectadoresList.length - 1)], // Nombre
					randomRange(10, 40), // Edad
					randomRange(5, 10)); // Saldo
	...
	// Mock datos pelis
	public static final String pelisList[] = { "BootCamp Killer","La pesadilla del Codigo Maldito", "El código Contrataca",
			 "Que paso? si esto antes compilaba" };
	
	// Mock datos espectadores
	public static final String espectadoresList[] = { "Asier", "Carla", "Jordi", "Toni", "Manel", "Feli", "Ivan", "Jan",
			"Oriol", "Adri", "Sergi", "Robert","Marc","Juanka","Alejandro" };

	
	public static int randomRange(int minimo, int maximo) {
