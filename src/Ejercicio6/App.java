...
public class App {
	...
	public static void main(String[] args) {
		...
		cine.showPrint(); // Mostramos la informaci�n de sala
	}
	...
	private static final String pelisList[] = { "BootCamp Killer", "La pesadilla del Codigo Maldito",
			"El c�digo Contrataca", "Que paso? si esto antes compilaba" };
	...
	private static Integer askValueNumeric(String txt) {
		...
		while (res <= 0) {
			...
			try {
				...
				System.err.println("Debes introducir un n�mero valido");
			}
		}
		return res;
	}
